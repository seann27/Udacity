...
class Binomial(Distribution):
    ...
    def replace_stats_with_data(self):
        ...
        """
        self.data_list = self.read_data_file(file)
    ...
    def pdf(self,k):
        ...
        n_minus_k_fact = math.factorial(self.n-k)
        term1 = n_fact / (k_fact * n_minus_k_fact)
        term2 = self.p**k
        term3 = (1-self.p)**(self.n-k)
    ...
    def plot_bar_pdf(self):
        ...
        plt.title('Probability Density for Distribution')
        plt.xlabel('k')
        plt.ylabel('pdf')
        return x,y
